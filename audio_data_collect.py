...
dataWithTranscripts.to_csv('script_available_data.csv', index=False, encoding='utf-8')

dataWithoutTranscripts.to_csv('src_for_noscripts.csv', index=False, encoding='utf-8')
